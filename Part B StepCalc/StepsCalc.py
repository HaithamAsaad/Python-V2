...
loc = "C:/Users/haithama/Desktop/KPIT training presentations/Python/20180723_12_27_32_data.xls"
...
accT = list(np.array(square(accX)) + np.array(square(accY)) + np.array(square(accY)))
Mag = sqrtList(accT)
# plot the magnitude
plt.plot(Mag, 'g')
plt.xlabel('time')
